...
> C is a powerful general-purpose programming language. It can be used to develop software like operating systems, databases, compilers, and so on. This projects covers the concepts of binary trees! This was a project done with the contribution of my peer in many other SWE projects  [Adeleye Ayomide Tosin](https://github.com/Tosinkuzzy/) Kudos!
...
https://github.com/Othmane-khan/binary_trees/blob/master/0-binary_tree_node.c
## Results :chart_with_upward
